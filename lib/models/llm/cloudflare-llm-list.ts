...
const DEEPSEEK_CODER_67B_BASE_AWQ: LLM = {
  modelId: "deepseek-coder-6.7b-base-awq",
...
const DEEPSEEK_CODER_67B_INSTRUCT_AWQ: LLM = {
  modelId: "deepseek-coder-6.7b-instruct-awq",
...
const DISCOLM_GERMAN_7B_V1_AWQ: LLM = {
  modelId: "discolm-german-7b-v1-awq",
...
const LLAMA_2_CHAT_HF_LORA: LLM = {
  modelId: "llama-2-7b-chat-hf-lora",
  modelName: "LLaMa 2 7B Chat HF Lora",
  provider: "cloudflare",
  hostedId: "@cf/meta/llama-2-7b-chat-hf-lora",
  platformLink: CLOUDFLARE_PLATFORM_LINK,
  imageInput: false
}
//llama-2-13b-chat-awq
const LLAMA_2_13B_CHAT_AWQ: LLM = {
  modelId: "llama-2-13b-chat-awq",
...
const MISTRAL_7B_INSTRUCT_V01_AWQ: LLM = {
  modelId: "mistral-7b-instruct-v0.1-awq",
...
const MISTRAL_7B_INSTRUCT_V02_LORA: LLM = {
  modelId: "mistral-7b-instruct-v0.2-lora",
  modelName: "Mistral 7B Instruct V0.2 Lora",
  provider: "cloudflare",
  hostedId: "@cf/mistral/mistral-7b-instruct-v0.2-lora",
  platformLink: CLOUDFLARE_PLATFORM_LINK,
  imageInput: false
}
//neural-chat-7b-v3-1-awq
const NEURAL_CHAT_7B_V3_1_AWQ: LLM = {
  modelId: "neural-chat-7b-v3-1-awq",
...
const OPENHERMES_25_MISTRAL_7B_AWQ: LLM = {
  modelId: "openhermes-2.5-mistral-7b-awq",
...
const UNA_CYBERTRON_7B_V2_BF16: LLM = {
  modelId: "una-cybertron-7b-v2-bf16",
